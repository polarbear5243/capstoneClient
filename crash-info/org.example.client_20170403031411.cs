...
Process Name: client
PID: 9609
Date: 2017-04-03 03:14:11+0900
Executable File Path: /opt/usr/apps/org.example.client/bin/client
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 9609, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00002589
...
b2a3b000 b323a000 rw-p [stack:9629]
...
b3744000 b3f43000 rw-p [stack:9621]
...
Callstack Information (PID:9609)
Call Stack Count: 1
...
(379) >  END
04-03 03:05:12.405+0900 E/cluster-home(  862): mainmenu-package-manager.cpp: _DoPkgJob(458) >  #Step 3 size[1]
04-03 03:05:12.405+0900 E/cluster-home(  862): mainmenu-package-manager.cpp: _DoPkgJob(462) >  appId[org.example.client]
04-03 03:05:12.415+0900 I/Tizen::App( 1235): (483) > pkgmgrinfo_appinfo_get_appid(): app = [org.example.client]
04-03 03:05:12.425+0900 E/PKGMGR  ( 1487): pkgmgr.c: __find_op_cbinfo(312) > tmp is NULL
04-03 03:05:12.425+0900 E/PKGMGR  ( 1487): pkgmgr.c: __find_op_cbinfo(312) > tmp is NULL
04-03 03:05:12.435+0900 I/Tizen::App( 1235): (416) > appName = [client]
04-03 03:05:12.435+0900 I/Tizen::App( 1235): (509) > exe = [/opt/usr/apps/org.example.client/bin/client], displayName = [client], mainApp = [1], menuIconVisible = [0], serviceApp = [0]
04-03 03:05:12.435+0900 E/cluster-home(  862): mainmenu-package-manager.cpp: _GetAppInfo(990) >  Name[client] enable[1] system[0]
04-03 03:05:12.435+0900 E/HOME_APPS(  862): mainmenu-package-manager.cpp: _DoPkgJob(484) >  appId[org.example.client] mdm is not enabled
04-03 03:05:12.435+0900 E/PKGMGR_INFO( 1235): pkgmgrinfo_appinfo.c: pkgmgrinfo_appinfo_get_list(887) > (component == PMINFO_SVC_APP) PMINFO_SVC_APP is done
04-03 03:05:12.435+0900 I/Tizen::App( 1235): (683) > Application count(1) in this package
04-03 03:05:12.435+0900 I/Tizen::App( 1235): (840) > Enter.
04-03 03:05:12.435+0900 E/cluster-home(  862): mainmenu-package-manager.cpp: GetAppInfo(630) >  Find a App Info Name[client] enable[1] system[0]
04-03 03:05:12.435+0900 W/HOME_APPS(  862): mainmenu-box-impl.cpp: UpdateBoxData(1326) >  update box data!!!!! old icon path[/opt/usr/apps/org.example.client/shared/res/client.png], New icon path[/opt/usr/apps/org.example.client/shared/res/client.png]!!!!!
04-03 03:05:12.435+0900 I/Tizen::App( 1235): (703) > Exit.
04-03 03:05:12.435+0900 I/Tizen::App( 1235): (1584) > Package = [org.example.client], Key = [end], Value = [ok], install = [1]
04-03 03:05:12.445+0900 I/Tizen::App( 1235): (416) > appName = [client]
04-03 03:05:12.445+0900 I/Tizen::App( 1235): (509) > exe = [/opt/usr/apps/org.example.client/bin/client], displayName = [client], mainApp = [1], menuIconVisible = [0], serviceApp = [0]
04-03 03:05:12.445+0900 I/Tizen::App( 1235): (2343) > info file is not existed. [/opt/usr/apps/org.exampl/info/org.example.client.info]
04-03 03:05:12.445+0900 I/Tizen::App( 1235): (131) > Enter
04-03 03:05:12.445+0900 I/Tizen::App( 1235): (137) > org.example.client does not have launch condition
04-03 03:05:12.445+0900 I/Tizen::App( 1235): (883) > Exit.
04-03 03:05:12.455+0900 E/util-view(  862): util-text-image-provider.cpp: GetPixelsFromText(240) >  DEFAULT='font=SamsungOneUI:style=Regular style=shadow,bottom shadow_color=# font_size=28 align=center valign=top color=#FFFFFF color_class=ATO001 text_class=ATO001 ellipsis=1 wrap=mixed linegap=-3'
04-03 03:05:12.475+0900 E/PKGMGR_SERVER( 9185): pkgmgr-server.c: sighandler(417) > child NORMAL exit [9239]
04-03 03:05:12.755+0900 E/PKGMGR_SERVER( 9185): pkgmgr-server.c: exit_server(1381) > exit_server Start [backend_status=1, queue_status=1, drm_status=1] 
04-03 03:05:12.755+0900 E/PKGMGR_SERVER( 9185): pkgmgr-server.c: main(2471) > package manager server terminated.
04-03 03:05:16.829+0900 W/AUL     ( 9297): launch.c: app_request_to_launchpad(396) > request cmd(0) to(org.example.client)
04-03 03:05:16.829+0900 W/AUL_AMD (  611): amd_request.c: __request_handler(906) > __request_handler: 0
04-03 03:05:16.839+0900 I/AUL     (  611): menu_db_util.h: _get_app_info_from_db_by_apppath(242) > path : /usr/bin/launch_app, ret : 0
04-03 03:05:16.849+0900 I/AUL     (  611): menu_db_util.h: _get_app_info_from_db_by_apppath(242) > path : /bin/bash, ret : 0
04-03 03:05:16.849+0900 E/AUL_AMD (  611): amd_launch.c: _start_app(2499) > no caller appid info, ret: -1
04-03 03:05:16.849+0900 W/AUL_AMD (  611): amd_launch.c: _start_app(2508) > caller pid : 9297
04-03 03:05:16.849+0900 E/AUL_AMD (  611): amd_appinfo.c: appinfo_get_value(1296) > appinfo get value: Invalid argument, 19
04-03 03:05:16.859+0900 E/RESOURCED(  634): block.c: block_prelaunch_state(134) > insert data org.example.client, table num : 3
04-03 03:05:16.859+0900 E/RESOURCED(  634): heart-memory.c: heart_memory_get_data(601) > hashtable heart_memory_app_list is NULL
04-03 03:05:16.859+0900 W/AUL_AMD (  611): amd_launch.c: _start_app(3052) > pad pid(-4)
04-03 03:05:16.979+0900 W/AUL     (  611): app_signal.c: aul_send_app_launch_request_signal(423) > send_app_launch_signal, pid: 9299, appid: org.example.client
04-03 03:05:16.979+0900 E/AUL     (  611): amd_app_group.c: app_group_start_app(1037) > app_group_start_app
04-03 03:05:16.989+0900 W/AUL     ( 9297): launch.c: app_request_to_launchpad(425) > request cmd(0) result(9299)
04-03 03:05:17.980+0900 W/AUL_AMD (  611): amd_key.c: _key_ungrab(269) > fail(-1) to ungrab key(XF86Back)
04-03 03:05:17.980+0900 W/AUL_AMD (  611): amd_launch.c: __grab_timeout_handler(1623) > back key ungrab error
04-03 03:05:20.773+0900 I/abc     ( 9299): abc
04-03 03:05:20.803+0900 I/CAPI_APPFW_APPLICATION( 9299): app_main.c: ui_app_main(789) > app_efl_main
04-03 03:05:21.974+0900 W/AUL     (  611): amd_app_group.c: __set_fg_flag(190) > send_signal BG org.example.client(9299)
04-03 03:05:21.974+0900 W/AUL     (  611): app_signal.c: aul_send_app_status_change_signal(581) > send_app_status_change_signal, pid: 9299, appid: org.example.client, status: bg
04-03 03:05:22.014+0900 I/CAPI_APPFW_APPLICATION( 9299): app_main.c: _ui_app_appcore_create(641) > app_appcore_create
04-03 03:05:24.236+0900 E/TBM     ( 9299): tbm_bufmgr.c: _tbm_bufmgr_init_state(691) > USE TGL LOCK!
04-03 03:06:00.652+0900 I/INDICATOR(  630): clock.c: indicator_clock_changed_cb(195) > ""
04-03 03:06:00.652+0900 E/UXT     (  630): uxt_util.c: uxt_util_get_date_time_text_by_locale(389) > text : 오전 3:06
04-03 03:06:00.652+0900 I/INDICATOR(  630): clock.c: getTimeFormatted(176) > "time format : 오전 3:06"
04-03 03:06:00.652+0900 I/INDICATOR(  630): clock.c: indicator_clock_changed_cb(244) > "time format : 오전 3:06"
04-03 03:06:00.652+0900 W/INDICATOR(  630): clock.c: indicator_clock_changed_cb(272) > 
04-03 03:06:00.652+0900 I/INDICATOR(  630): clock.c: indicator_clock_changed_cb(317) > "[CLOCK MODULE] Timer Status : -2145838444 Time: <font_size=31> </font_size> <font_size=31> 오전 3:06</font_size></font>"
04-03 03:06:26.027+0900 E/INDICATOR(  630): list.c: list_try_to_find_icon_to_show(299) > (!icon) -> list_try_to_find_icon_to_show() return
04-03 03:06:26.027+0900 E/INDICATOR(  630): list.c: list_try_to_find_icon_to_show(299) > (!icon) -> list_try_to_find_icon_to_show() return
04-03 03:06:26.027+0900 E/INDICATOR(  630): list.c: list_try_to_find_icon_to_show(299) > (!icon) -> list_try_to_find_icon_to_show() return
04-03 03:06:26.027+0900 E/INDICATOR(  630): list.c: list_try_to_find_icon_to_show(299) > (!icon) -> list_try_to_find_icon_to_show() return
04-03 03:06:26.027+0900 E/INDICATOR(  630): box.c: _update_icon(232) > (!list) -> _update_icon() return
04-03 03:06:26.027+0900 E/INDICATOR(  630): box.c: _update_icon(232) > (!list) -> _update_icon() return
04-03 03:06:26.027+0900 E/INDICATOR(  630): list.c: list_try_to_find_icon_to_remove(378) > (!icon) -> list_try_to_find_icon_to_remove() return
04-03 03:06:26.027+0900 E/INDICATOR(  630): list.c: list_try_to_find_icon_to_show(299) > (!icon) -> list_try_to_find_icon_to_show() return
04-03 03:06:26.027+0900 E/INDICATOR(  630): list.c: list_try_to_find_icon_to_show(299) > (!icon) -> list_try_to_find_icon_to_show() return
04-03 03:06:26.027+0900 E/INDICATOR(  630): list.c: list_try_to_find_icon_to_show(299) > (!icon) -> list_try_to_find_icon_to_show() return
04-03 03:06:26.027+0900 E/INDICATOR(  630): box.c: _update_icon(232) > (!list) -> _update_icon() return
04-03 03:06:26.027+0900 E/INDICATOR(  630): box.c: _update_icon(232) > (!list) -> _update_icon() return
04-03 03:07:00.660+0900 I/INDICATOR(  630): clock.c: indicator_clock_changed_cb(195) > ""
04-03 03:07:00.660+0900 E/UXT     (  630): uxt_util.c: uxt_util_get_date_time_text_by_locale(389) > text : 오전 3:07
04-03 03:07:00.660+0900 I/INDICATOR(  630): clock.c: getTimeFormatted(176) > "time format : 오전 3:07"
04-03 03:07:00.660+0900 I/INDICATOR(  630): clock.c: indicator_clock_changed_cb(244) > "time format : 오전 3:07"
04-03 03:07:00.660+0900 W/INDICATOR(  630): clock.c: indicator_clock_changed_cb(272) > 
04-03 03:07:00.660+0900 I/INDICATOR(  630): clock.c: indicator_clock_changed_cb(317) > "[CLOCK MODULE] Timer Status : -2145811768 Time: <font_size=31> </font_size> <font_size=31> 오전 3:07</font_size></font>"
04-03 03:08:00.709+0900 I/INDICATOR(  630): clock.c: indicator_clock_changed_cb(195) > ""
04-03 03:08:00.719+0900 E/UXT     (  630): uxt_util.c: uxt_util_get_date_time_text_by_locale(389) > text : 오전 3:08
...
04-03 03:14:05.785+0900 E/INDICATOR(  630): box.c: _update_icon(232) > (!list) -> _update_icon() return
04-03 03:14:11.941+0900 W/CRASH_MANAGER( 9632): worker.c: worker_job(1199) > 0609609636c69149115685
