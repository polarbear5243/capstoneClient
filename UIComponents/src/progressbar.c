...
/*
 * @brief Function will be operated when progress bar is deleted
...
/*
 * @brief Function to create pending style progress bar
 * @param[in] parent The Evas object which progress bar object is created on
 * @param[out] Evas_Object* The progressbar object which is created
 */
static Evas_Object *
...
static Evas_Object *
create_pending_progressbar_with_name(Evas_Object *parent)
{
	Evas_Object *progressbar;
...
/*
 * @brief Function to create progress bar with style
 * @param[in] parent The Evas object which progress bar object is created on
 * @param[in] style The style name of progress bar
 * @param[out] Evas_Object* The progressbar object which is created
 */
static Evas_Object *
...
/*
 * @brief Function to create default style progress bar
 * @param[in] parent The Evas object which progress bar object is created on
 * @param[out] Evas_Object* The progressbar object which is created
 */
static Evas_Object*
...
static Evas_Object*
create_default_progressbar_with_name(Evas_Object *parent)
{
	Evas_Object *progressbar;
	Ecore_Timer *progress_timer;
...
/*
 * @brief Function to create label object
 * @param[in] parent The Evas object which label object is created on
 * @param[in] text The string will be set in label
...
create_content(Evas_Object* parent)
{
	...
	progressbar = create_default_progressbar_with_name(box);
	elm_box_pack_end(box, progressbar);
	...
	elm_box_pack_end(box, progressbar);
	progressbar = create_pending_progressbar_with_name(box);
	elm_box_pack_end(box, progressbar);
...
/*
 * @brief Function will be operated when main menu "Progressbar" is clicked
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
progressbar_cb(void *data, Evas_Object *obj EINA_UNUSED, void *event_info EINA_UNUSED)
{
	...
	elm_layout_file_set(layout, ELM_DEMO_EDJ, "progressbar_bg_layout");
