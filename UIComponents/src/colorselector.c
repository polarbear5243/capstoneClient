...
/*
 * @brief Function to create color selector object
 * @param[in] parent The Evas object which color selector object is created on
...
/*
 * @brief Function will be operated when main menu "Colorselector" is clicked
