...
/*
 * @brief Function will be operated when hoversel item is clicked
...
/*
 * @brief Function will be operated when hoversel item is selected
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
/*
 * @brief Function will be operated when hoversel is dismissed
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
/*
 * @brief Function to create hoversel view layout
...
{
	Evas_Object *box, *layout, *hoversel;
	...
	/* Add Hoversel */
	hoversel = elm_hoversel_add(layout);
	...
	elm_object_part_content_set(layout, "elm.swallow.content", hoversel);
...
/*
 * @brief Function will be operated when main menu "Hoversel" is clicked
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
