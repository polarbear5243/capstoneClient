...
/*
 * @brief Function will be operated when mouse move up is triggered on index object
 * @param[in] data The data to be passed to the callback function
 * @param[in] e The Evas object handle to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
...
/*
 * @brief Function will be operated when scroll object is scrolled
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
/*
 * @brief Function will be operated when index object is deleted
 * @param[in] data The data to be passed to the callback function
 * @param[in] e The Evas object handle to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
...
/*
 * @brief Function will be operated when "Horizontal Style" menu is clicked
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
