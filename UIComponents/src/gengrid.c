...
/*
 * @brief Function will be operated when moved event is triggered on gengrid
...
/*
 * @brief Function will be operated when longpressed event is triggered on gengrid
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
/*
 * @brief Function to get string on gengrid item's text part
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] part The name of text part
 * @param[out] char* A string with the characters to use as gengrid item's text part
 */
static char*
...
/*
 * @brief Function to get Evas object on gengrid item's swallow part
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] part The name of swallow part
 * @param[out] Evas_Object* The Evas object is set on gengrid item's swallow part
 */
static Evas_Object*
...
/*
 * @brief Function will be operated when gengrid item is clicked
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
gengrid_it_cb(void *data, Evas_Object *obj, void *event_info)
{
	...
	dlog_print(DLOG_INFO, LOG_TAG, "item selected: %p", it);
...
/*
 * @brief Function will be operated when gengrid item is realized
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
{
	dlog_print(DLOG_INFO, LOG_TAG, "[%s][%d]", __func__, __LINE__);
}

/*
 * @brief Function to create gengrid object
 * @param[in] vd The data structure which have gengrid options
...
/*
 * @brief Function will be operated when "Gengrid Type1" menu is clicked
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
gengrid_type1_cb(void *data, Evas_Object *obj, void *event_info)
{
	...
	vd->style = "default";  //type1 = default
							//You can both use of them for default gengrid style.
...
/*
 * @brief Function will be operated when "Gengrid Type2" menu is clicked
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
/*
 * @brief Function will be operated when "Gengrid Multiselect" menu is clicked
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
/*
 * @brief Function will be operated when main menu "Gengrid" is clicked
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
