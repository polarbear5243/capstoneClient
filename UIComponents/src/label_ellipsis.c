...
/*
 * @brief Function to create label layout
...
create_labels(Evas_Object *parent)
{
	...
	elm_object_text_set(label3, _("<font_size=24>If the string length exceeds the width of the widget, then the string will be ellipsised by label. but it's a experimental api and very slow function.</font_size>"));
	...
	elm_object_text_set(label4, _("<font_size=24>If the string length exceeds the width of the widget, then the string will be ellipsised by label. but it's a experimental api and very slow function.</font_size>"));
	...
	elm_object_text_set(label5, _("If the string length exceeds the width of the widget, then the string will be ellipsised by label. However, it's a experimental api and very slow function. Ellipsis feature supports multiline texts. Programmers should not misuse multiline ellipsis. It's slow a function."));
...
/*
 * @brief Function will be operated when "Ellipsis" menu is clicked
