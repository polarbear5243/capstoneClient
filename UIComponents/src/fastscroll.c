...
/*
 * @brief Function will be operated when index's item is selected
...
/*
 * @brief Function will be operated when index item selection is changed
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
/*
 * @brief Function will be operated when language changed event is triggered on index
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
/*
 * @brief Function to create fastscroll object
 * @param[in] scroller The scroller object which fastscroll object is created on
 * @param[out] Evas_Object* The Evas object which is created
 */
static Evas_Object*
...
/*
 * @brief Function will be operated when main menu "Fastscroll" is clicked
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
