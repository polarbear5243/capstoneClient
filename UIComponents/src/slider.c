...
/*
 * @brief Function to create slider object
 * @param[in] parent The Evas object which slider object is created on
 * @param[in] style The style of slider
 * @param[in] indicator Visible of slider
 * @param[in] horizontal Horizontal flag of slier
...
/*
 * @brief Function to create vertical scrollable layout
...
/*
 * @brief Function to create horizontal scrollable layout
 * @param[in] parent The Evas object which layout object is created on
 * @param[out] Evas_Object* The Evas object which is created
 */
static Evas_Object *
...
/*
 * @brief Function will be operated when "Vertical Style" menu is clicked
 ...
 * @param[in] nf The naviframe object which list object is created on
 * @param[out] Evas_Object* The Evas object which is created
 */
static Evas_Object*
...
/*
 * @brief Function will be operated when main menu "Slider" is clicked
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
