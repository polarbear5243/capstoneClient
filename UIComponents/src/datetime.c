...
/*
 * @brief Function will be operated when "Cancel" button in popup is clicked
...
/*
 * @brief Function will be operated when "Set" button in popup is clicked
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
/*
 * @brief Function to create datetime popup object
 * @param[in] dd The data structure to manage gui objects
 */
static void
...
/*
 * @brief Function to show popup when button is clicked
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
/*
 * @brief Function to create button object
 * @param[in] dd The data structure to manage gui objects
 * @param[in] parent The Evas object which button object is created on
 * @param[in] text Button text
 * @param[in] format Datetime text format in popup
...
/*
 * @brief Function will be operated when main menu "Datetime" is clicked
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
