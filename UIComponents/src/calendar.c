...
/*
 * @brief Function to create calendar object
 * @param[in] nf The naviframe object which calendar object is created on
...
/*
 * @brief Function will be operated when main menu "Calendar" is clicked
