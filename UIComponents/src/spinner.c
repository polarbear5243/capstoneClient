...
/*
 * @brief Function will be operated when spinner's value is changed
...
{
	dlog_print(DLOG_INFO, LOG_TAG, "Value changed to %0.f", elm_spinner_value_get(obj));
}

/*
 * @brief Function will be operated when a short time delayed after spinner's value is changed
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
{
	dlog_print(DLOG_INFO, LOG_TAG, "Value delay changed to %0.f", elm_spinner_value_get(obj));
}

/*
 * @brief Function to create spinner layout
...
/*
 * @brief Function will be operated when main menu "Spinner" is clicked
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
