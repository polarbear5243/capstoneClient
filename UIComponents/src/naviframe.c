...
/*
 * @brief Function to quit main menu when next to fourth naviframe item
...
/*
 * @brief Function to create virtual button for menu key callback handler
 * If menu key is pressed, naviframe's more/default style button is clicked
 * @param[in] parent The Evas object which button is created in
 * @param[in] func The function will be operated when menu key is pressed
 * @param[in] data The data will be passed to the callback function
...
/*
 * @brief Function will be operated when "Prev" button is clicked
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
/*
 * @brief Function to create content object in naviframe page
 * @param[in] parent The naviframe object which content object is created in
 * @param[in] text The text will be inserted in content
 * @param[in] next_btn_clicked_cb The function will be operated when "next" button is clicked
 * @param[out] Evas_Object* The Evas object which is created
 */
static Evas_Object*
...
/*
 * @brief Function to create fourth naviframe page
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
/*
 * @brief Function to create third naviframe page
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
/*
 * @brief Function to create second naviframe page
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
/*
 * @brief Function to create first naviframe page
 * @param[in] nf The naviframe object which page is inserted to
 */
static void
...
/*
 * @brief Function will be operated when main menu "Naviframe" is clicked
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
