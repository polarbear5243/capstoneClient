...
/*
 * @brief Function will be operated when "Vertical Handler" menu is clicked
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
...
/*
 * @brief Function to create scroller object for horizontal handler
...
create_horz_handler_scroller(Evas_Object *parent)
{
	...
	snprintf(buf, sizeof(buf), "%s/horz_scrollbar.png", ICON_DIR);
...
/*
 * @brief Function will be operated when "Horizontal Handler" menu is clicked
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
 ...
 * @param[in] parent The Evas object which list object is created on
 * @param[out] Evas_Object* The Evas object is created
 */
static Evas_Object*
...
/*
 * @brief Function will be operated when main menu "Handler" is clicked
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
