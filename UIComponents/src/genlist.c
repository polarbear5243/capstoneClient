...
/*
 * @brief Function to create check object
 * @param[in] parent The Evas object which check object is created on
 * @param[out] Evas_Object8 The check object is created
 */
static Evas_Object*
...
/*
 * @brief Function to get Evas object on genlist type1 1line item's swallow part
 ...
 * @param[out] Evas_Object* The Evas object is set on genlist item's swallow part
 */
static Evas_Object*
...
/*
 * @brief Function to get string on genlist type1 1line item's text part
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
...
/*
 * @brief Function to get Evas object on genlist type1 2line item's swallow part
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] part The name of swallow part
 * @param[out] Evas_Object* The Evas object is set on genlist item's swallow part
...
/*
 * @brief Function to get string on genlist type1 2line item's text part
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] part The name of text part
 * @param[out] char* A string with the characters to use as genlist item's text part
...
/*
 * @brief Function to get string on genlist multiline item's text part
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] part The name of text part
 * @param[out] char* A string with the characters to use as genlist item's text part
...
/*
 * @brief Function to get Evas object on genlist full style item's swallow part
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] part The name of swallow part
 * @param[out] Evas_Object* The Evas object is set on genlist item's swallow part
...
/*
 * @brief Function to get Evas object on genlist group_index style item's swallow part
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] part The name of swallow part
 * @param[out] Evas_Object* The Evas object is set on genlist item's swallow part
...
group_index_content_get_cb(void *data, Evas_Object *obj, const char *part)
{
	...
	if ((id->index / 7) % 3 == 0)
		...
		elm_atspi_accessible_description_set(ret, "Tick box for the entire group");
...
/*
 * @brief Function to get string on genlist group_index style item's text part
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] part The name of text part
 * @param[out] char* A string with the characters to use as genlist item's text part
...
/*
 * @brief Function will be operated when "loaded" event is triggered on genlist
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
...
{
	dlog_print(DLOG_INFO, LOG_TAG, "loaded");
}

/*
 * @brief Function will be operated when "realized" event is triggered on genlist
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
gl_realized_cb(void *data, Evas_Object *obj, void *event_info)
{
	...
	dlog_print(DLOG_INFO, LOG_TAG, "%s: [%d]", __func__, id->index);
}

/*
 * @brief Function will be operated when "longpressed" event is triggered on genlist
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
/*
 * @brief Function will be operated when "mouse down" event is triggered on genlist
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
gl_mouse_down_cb(void *data, Evas *e, Evas_Object *obj, void *event_info)
{
	...
	dlog_print(DLOG_INFO, LOG_TAG, "down %d %d (%d) (%p)", ev->canvas.x, ev->canvas.y, elm_genlist_item_index_get(it), it);
}

/*
 * @brief Function will be operated when expand genlist
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
/*
 * @brief Function will be operated when contract genlist
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
/*
 * @brief Function will be operated when sub menu is clicked
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
genlist_test_cb(void *data, Evas_Object *obj EINA_UNUSED, void *event_info)
{
	...
	dlog_print(DLOG_INFO, LOG_TAG, "Item style: %s", style);
...
/*
 * @brief Function will be operated when main menu "Genlist" is clicked
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
