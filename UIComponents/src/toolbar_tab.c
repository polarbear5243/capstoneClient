...
create_2_icon_text_tabbar(Evas_Object *parent)
{
	...
	snprintf(buf, sizeof(buf), "%s/Clock_tabs_icon_alarm.png", ICON_DIR);
	item = elm_toolbar_item_append(toolbar, buf, "Alarm", toolbar_it_cb, parent);
	snprintf(buf, sizeof(buf), "%s/Clock_tabs_icon_world_clock.png", ICON_DIR);
	elm_toolbar_item_append(toolbar, buf, "World Clock", toolbar_it_cb, parent);
...
create_3_icon_text_tabbar(Evas_Object *parent)
{
	...
	snprintf(buf, sizeof(buf), "%s/Clock_tabs_icon_alarm.png", ICON_DIR);
	elm_toolbar_item_append(toolbar, buf, "Alarm", toolbar_it_cb, parent);
	snprintf(buf, sizeof(buf), "%s/Clock_tabs_icon_world_clock.png", ICON_DIR);
	elm_toolbar_item_append(toolbar, buf, "World Clock", toolbar_it_cb, parent);
	snprintf(buf, sizeof(buf), "%s/Clock_tabs_icon_timer.png", ICON_DIR);
	elm_toolbar_item_append(toolbar, buf, "Timer", toolbar_it_cb, parent);
...
create_4_icon_text_tabbar(Evas_Object *parent)
{
	...
	snprintf(buf, sizeof(buf), "%s/Clock_tabs_icon_timer.png", ICON_DIR);
	elm_toolbar_item_append(toolbar, buf, "Timer", toolbar_it_cb, parent);
	snprintf(buf, sizeof(buf), "%s/Clock_tabs_icon_world_stopwatch.png", ICON_DIR);
	elm_toolbar_item_append(toolbar, buf, "Stopwatch", toolbar_it_cb, parent);
...
/*
 * @brief Function to create dialer list layout
...
/*
 * @brief Function to create song list layout
 * @param[in] parent The Evas object which layout object is created on
 * @param[out] Evas_Object* The Evas object which is created
 */
static Evas_Object *
...
/*
 * @brief Function to create artist list layout
 * @param[in] parent The Evas object which layout object is created on
 * @param[out] Evas_Object* The Evas object which is created
 */
static Evas_Object *
...
/*
 * @brief Function to create play list layout
 * @param[in] parent The Evas object which layout object is created on
 * @param[out] Evas_Object* The Evas object which is created
 */
static Evas_Object *
...
/*
 * @brief Function to create main list layout
 * @param[in] parent The Evas object which layout object is created on
 * @param[out] Evas_Object* The Evas object which is created
 */
static Evas_Object *
...
/*
 * @brief Function will be operated when toolbar's item is clicked
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
/*
 * @brief Function will be operated when "Navigation Style" menu is clicked
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
