...
/*
 * @brief Function will be operated when progressbar object is deleted
...
/*
 * @brief Function will be operated when timeout event is triggered on popup
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
gl_sel_cb(void *data, Evas_Object *obj, void *event_info)
{
	...
	dlog_print(DLOG_INFO, LOG_TAG, "selected text %s", items[index]);
	dlog_print(DLOG_INFO, LOG_TAG, "Index of the list=%d", index);
	elm_popup_dismiss(popup);
}
...
/*
 * @brief Function will be operated when popup's block area is clicked
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
/*
 * @brief Function will be operated when button in popup is clicked
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
/*
 * @brief Function will be operated when popup is dismissed
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
list_it_image_text_cb(void *data, Evas_Object *obj, void *event_info)
{
	...
	evas_object_smart_callback_add(popup, "dismissed", popup_dismissed_cb, NULL);
...
list_it_2text_progressbar_cb(void *data, Evas_Object *obj, void *event_info)
{
	...
	elm_object_part_text_set(layout, "elm.subtext.description", "Secondary Text");
	evas_object_size_hint_weight_set(layout, EVAS_HINT_EXPAND, EVAS_HINT_EXPAND);
...
/*
 * @brief Function will be operated when main menu "Popup" is clicked
 * @param[in] data The data to be passed to the callback function
 * @param[in] obj The Evas object handle to be passed to the callback function
 * @param[in] event_info The system event information
 */
...
popup_cb(void *data, Evas_Object *obj, void *event_info)
{
	...
	elm_list_item_append(list, "popup - list + 2 buttons", NULL, NULL, list_it_list_cb, win);
	elm_list_item_append(list, "popup - list (2 line)", NULL, NULL, list_it_2line_cb, win);
